...
export default function MovieForm({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const data = {
      ...
      tmdb_id: editingMovie.tmdbId || null,
      imdb_id: editingMovie.imdbId || null,
      tagline: taglineText || null,
      runtime: Number(form.get('runtime')) || null,
      budget: editingMovie.budget || null,
      revenue: editingMovie.revenue || null,
      original_language: editingMovie.originalLanguage || null,
      popularity: editingMovie.popularity || null,
      vote_count: editingMovie.voteCount || null,
      homepage: editingMovie.homepage || null,
